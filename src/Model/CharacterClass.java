...
public enum CharacterClass {
    ...
    public CharacterStats getBaseStats() {
        try {
            ...
            stats.addStat(AttributeType.STRENGTH.getAdditionalDescription(classData.getInt("base_str")));
            stats.addStat(AttributeType.DEXTERITY.getAdditionalDescription(classData.getInt("base_dex")));
            stats.addStat(AttributeType.INTELLIGENCE.getAdditionalDescription(classData.getInt("base_int")));
            return stats;
        } catch (Exception e) {
